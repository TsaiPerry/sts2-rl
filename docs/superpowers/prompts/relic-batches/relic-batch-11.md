...
- `tools/audit/relic_probes_b11.py` — **your own** probe module (see below)
...
`tools/audit/relic_probes_b11.py` with its own `main()`; run it as
`py tools/audit/relic_probes_b11.py`. Do NOT register anything in the
...
5. `git add audits/relic tools/audit/relic_probes_b11.py .superpowers/sdd/relic-batch-11-lessons.md`
